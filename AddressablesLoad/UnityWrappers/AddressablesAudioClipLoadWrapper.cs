...
{
    public sealed class AddressablesAudioClipLoadWrapper : AddressablesLoadWrapper<AddressablesAudioClipLoadHandle, AudioClip>
    {
        ...
        protected override void ApplyView(AssetLoadState state, AudioClip asset, AssetLoadData<AudioClip, AddressablesLoadInfo> data)
        {
